...
import DirectLocale from "@/features/product/prototypes/catalogLocalization/DirectLocale";
import EditorialEditions from "@/features/product/prototypes/catalogLocalization/EditorialEditions";
import LanguageSheet from "@/features/product/prototypes/catalogLocalization/LanguageSheet";
import type { PrototypeLocale } from "@/features/product/prototypes/catalogLocalization/localizationCopy";

export const Route = createFileRoute("/prototypes/catalog-localization")({
	component: CatalogLocalizationPrototype,
	...
	head: () => ({
		meta: [{ title: "Catalog localization exploration · Takonbini" }],
		links: [
...
const variants = [
	{ name: "Direct", component: DirectLocale },
	{ name: "Editions", component: EditorialEditions },
	{ name: "Language Sheet", component: LanguageSheet },
];

function CatalogLocalizationPrototype() {
